...
def webpay_plus_create(request):
    ...
    return render(request, 'core/send-pay.html', {'response': response, 'amount': amount})    
...
def commitpay(request):
    ...
    return render(request, 'core/commit-pay.html', {'transaction_detail': transaction_detail})    
